...
knitr::opts_knit$set(root.dir = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/codes/dataframes")
...
tab1 <- function(df){
  ...
  table_overall <- print(table_overall, printToggle = FALSE, noSpaces = TRUE, catDigits = 1, contDigits = 1, pDigits = 3,
  ...
  table_stratified <- print(table_stratified, printToggle = FALSE, noSpaces = TRUE, catDigits = 1, contDigits = 1, pDigits = 3,
                            nonnormal = c("cov_age", "cov_egfr", "cov_hr", "cov_bpsys", "cov_bpdia", "cov_bmi", "cov_hr", "cov_ntprobnp"), 
                            smd = FALSE) 
...
barplot <- function(type, ef){
  ...
  ggsave(plot = plot, filename = paste0(paste("barplot", type, ef, sep = "_"), ".pdf"), 
         path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/Figures/Barplots/", width = 8, height = 5, dpi = 600)
...
fps <- function(ef){
  ...
  ggsave(filename = paste0("fp_props_", ef, ".png"), plot = plot, 
         path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/figures/forest plots", width = 9, height = 8, dpi = 600)
...
plt.spline <- function(type, ef, drg){
  ...
  ggsave(filename = paste0("splines_", type, "_", ef, "_", drg, ".png"), plot = plot, 
         path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/figures/splines", width = 9, height = 8, dpi = 600)
...
prps <- function(type, ef, drg){
  ...
  if(type == "adherence"){
    e.60 <- n.60 - table(filter(dat.temp, exp_egfr == "eGFR >60")$pdc_ind)[["0"]]
    e.45 <- n.45 - table(filter(dat.temp, exp_egfr == "eGFR 45-59")$pdc_ind)[["0"]]
    e.30 <- n.30 - table(filter(dat.temp, exp_egfr == "eGFR 30-44")$pdc_ind)[["0"]]
    e.00 <- n.00 - table(filter(dat.temp, exp_egfr == "eGFR <30")$pdc_ind)[["0"]]
  }
...
cifs <- function(drg, ef, zoom = FALSE){
  ...
  ggsave(savename, path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/figures/cifs", dpi = 600, width = 10, height = 5)
}
...
writexl::write_xlsx(tab.rEF, path = "restart_rEF.xlsx")
...
writexl::write_xlsx(tab.mEF, path = "restart_mEF.xlsx")
...
fps <- function(type, ef){
  ...
  uplim <- ifelse(type == "adherence", 1.6, 2)
  uptik <- ifelse(type == "adherence", 1.6, 2)
  ...
  ggsave(filename = paste0("fp_", type, "_", ef, ".png"), plot = plot, 
         path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/figures/forest plots", width = wd, height = 5, dpi = 600)
...
fig <- function(type, drg, ef){
  ...
  ggsave(plot, file = paste("C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/Figures/Forest plots/Predictors/fp", type, ef, drg, ".png", sep = "_"),
         width = 8, height = 5, dpi = 600)
  
  ggsave(plot, file = paste("C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/Figures/Forest plots/Predictors/fp", type, ef, drg, ".pdf", sep = "_"),
         width = 8, height = 5, dpi = 600)
}
...
fps <- function(ef, outcome){
  ...
  ggsave(filename = paste0("fp_", outcome, "_", ef, ".png"), plot = plot, 
         path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/Figures/Forest plots/", width = 8, height = 5, dpi = 600)
...
plots <- function(type, ef){
  ...
  ggsave(paste0("fp_", type, "_", ef, ".png"), plot = plot, 
         path = "C:/Users/rjjanse.lumcnet/onedrive - lumc/research/projects/7. gdt_hf_ckd/Figures/Forest plots/Temporal/", width = 10.5, height = 10, dpi = 600)
...
plots <- function(type, ef){
  ...
  if(type == "adherence" & ef == "mEF"){
    # Add arrow for truncated confidence intervals
    fplot <- fplot + geom_segment(inherit.aes = FALSE, aes(x = 5.4, y = 3, xend = 5.67, yend = 3), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) 
  }
  
  if(type == "persistence" & ef == "rEF"){
    # Add arrow for truncated confidence intervals
    fplot <- fplot + geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 3, xend = 1.745, yend = 3), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 8, xend = 1.745, yend = 8), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#117733", fill = "#117733",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 40, xend = 1.745, yend = 40), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#44AA99", fill = "#44AA99",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 41, xend = 1.745, yend = 41), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#117733", fill = "#117733",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 42, xend = 1.745, yend = 42), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 43, xend = 1.745, yend = 43), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#44AA99", fill = "#44AA99",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 46, xend = 1.745, yend = 46), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#44AA99", fill = "#44AA99",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 47, xend = 1.745, yend = 47), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#117733", fill = "#117733",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.68, y = 48, xend = 1.745, yend = 48), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) 
  }
  ...
  if(type == "persistence" & ef == "mEF"){
    # Add arrow for truncated confidence intervals
    fplot <- fplot + geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 1, xend = 2.07, yend = 1), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#44AA99", fill = "#44AA99",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 2, xend = 2.07, yend = 2), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#117733", fill = "#117733",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      ...
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 6, xend = 2.07, yend = 6), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 7, xend = 2.07, yend = 7), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#44AA99", fill = "#44AA99",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      ...
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 9, xend = 2.07, yend = 9), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 16, xend = 2.07, yend = 16), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 19, xend = 2.07, yend = 19), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 21, xend = 2.07, yend = 21), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#117733", fill = "#117733",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 46, xend = 2.07, yend = 46), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#44AA99", fill = "#44AA99",
                                  arrow = arrow(length = unit(0.2, "cm"))) + 
      geom_segment(inherit.aes = FALSE, aes(x = 1.9, y = 48, xend = 2.07, yend = 48), 
                                  lineend = "round", linejoin = "mitre", size = 0.5, colour = "#332288", fill = "#332288",
                                  arrow = arrow(length = unit(0.2, "cm")))
  }
