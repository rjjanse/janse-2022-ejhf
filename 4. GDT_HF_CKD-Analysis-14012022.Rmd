...
cifs <- function(drg, ef, zoom = FALSE){
  ...
  ggsave(savename, path = "", dpi = 600, width = 10, height = 5)
}
...
fps <- function(type, ef){
  ...
  ggsave(filename = paste0("fp_", type, "_", ef, ".png"), plot = plot, 
         path = "", width = wd, height = 5, dpi = 600)
...
fig <- function(type, drg, ef){
  ...
  ggsave(plot, file = paste("", type, ef, drg, ".png", sep = "_"),
         width = 8, height = 5, dpi = 600)
  
  ggsave(plot, file = paste("", type, ef, drg, ".pdf", sep = "_"),
         width = 8, height = 5, dpi = 600)
}
...
plots <- function(type, ef){
  ...
  ggsave(paste0("fp_", type, "_", ef, ".png"), plot = plot, 
         path = "", width = 10.5, height = 10, dpi = 600)
